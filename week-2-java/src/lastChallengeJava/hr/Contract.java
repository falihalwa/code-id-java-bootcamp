...
public class Contract extends Employee implements CalcSalary{
    public List<PayrollItem> listPayroll;
    public static int totalEmployee = 0;
    public static double totalEmployeeSalary = 0;

    public Contract(int empNo, String fullName, LocalDate hireDate, double baseSalary, List<PayrollItem> listPayroll) {
        super(empNo, fullName, hireDate, Status.CONTRACT, baseSalary);
    ...
    public void calculateSalary() {
        ...
        setTotalSalary(sal);
        Contract.totalEmployeeSalary += sal;
