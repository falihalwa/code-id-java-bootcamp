...
--
-- Name: oe; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA oe;


ALTER SCHEMA oe OWNER TO postgres;
...
ALTER SEQUENCE hr.departments_department_id_seq OWNER TO postgres;
...
ALTER SEQUENCE hr.dependents_dependent_id_seq OWNER TO postgres;
...
ALTER SEQUENCE hr.jobs_job_id_seq OWNER TO postgres;
...
ALTER SEQUENCE hr.locations_location_id_seq OWNER TO postgres;
...
ALTER SEQUENCE hr.regions_region_id_seq OWNER TO postgres;
...
--
-- Name: categories; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.categories OWNER TO postgres;

--
-- Name: customer_customer_demo; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.customer_customer_demo OWNER TO postgres;

--
-- Name: customer_demographics; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.customer_demographics OWNER TO postgres;

--
-- Name: customers; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.customers OWNER TO postgres;

--
-- Name: employee_territories; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.employee_territories OWNER TO postgres;

--
-- Name: employees; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.employees OWNER TO postgres;

--
-- Name: location_x; Type: TABLE; Schema: oe; Owner: postgres
--

CREATE TABLE oe.location_x (
    location_id bigint,
    street_address character varying(60),
    postal_code character varying(10),
    city character varying(15),
...
ALTER TABLE oe.location_x OWNER TO postgres;

--
-- Name: order_details; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.order_details OWNER TO postgres;

--
-- Name: orders; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.orders OWNER TO postgres;

--
-- Name: products; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.products OWNER TO postgres;

--
-- Name: region; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.region OWNER TO postgres;

--
-- Name: shippers; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.shippers OWNER TO postgres;

--
-- Name: suppliers; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.suppliers OWNER TO postgres;

--
-- Name: territories; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.territories OWNER TO postgres;

--
-- Name: us_states; Type: TABLE; Schema: oe; Owner: postgres
--
...
ALTER TABLE oe.us_states OWNER TO postgres;
...
COPY hr.departments (department_id, department_name, location_id) FROM stdin;
...
COPY hr.dependents (dependent_id, first_name, last_name, relationship, employee_id) FROM stdin;
...
COPY hr.employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, manager_id, department_id) FROM stdin;
...
3126	12 Orchestra Terrace	99362	Walla Walla	WA	US
3127	2732 Baker Blvd.	97403	Eugene	OR	US
3128	707 Oxford Rd.	48104	Ann Arbor	MI	US
3129	P.O. Box 555	82520	Lander	WY	US
3130	908 W. Capital Way	98401	Tacoma	WA	US
3131	722 Moss Bay Blvd.	98033	Kirkland	WA	US
3001	Av. del Libertador 900	1010	Buenos Aires	\N	AR
3002	Ing. Gustavo Moncada 8585 Piso 20-A	1010	Buenos Aires	\N	AR
3003	Cerrito 333	1010	Buenos Aires	\N	AR
3004	170 Prince Edward Parade Hunter's Hill	2042	Sydney	NSW	AU
3005	74 Rose St. Moonie Ponds	3058	Melbourne	Victoria	AU
3006	Kirchgasse 6	8010	Graz	\N	AT
3007	Geislweg 14	5020	Salzburg	\N	AT
3008	Rue Joseph-Bens 532	B-1180	Bruxelles	\N	BE
3009	Boulevard Tirou, 255	B-6000	Charleroi	\N	BE
3010	Alameda dos Canàrios, 891	05487-020	Sao Paulo	SP	BR
3011	Av. Inês de Castro, 414	05634-030	Sao Paulo	SP	BR
3012	Rua do Mercado, 12	08737-363	Resende	SP	BR
3013	Av. dos Lusíadas, 23	05432-043	Sao Paulo	SP	BR
3014	Av. das Americanas 12.890	5442	Sao Paulo	\N	BR
3015	Av. Copacabana, 267	02389-890	Rio de Janeiro	RJ	BR
3016	Rua Orós, 92	05442-030	Sao Paulo	SP	BR
3017	Rua da Panificadora, 12	02389-673	Rio de Janeiro	RJ	BR
3018	Rua do Paço, 67	05454-876	Rio de Janeiro	RJ	BR
3019	Av. Brasil, 442	04876-786	Campinas	SP	BR
3020	23 Tsawassen Blvd.	T2F 8M4	Tsawassen	BC	CA
3021	148 rue Chasseur	J2S 7S8	Ste-Hyacinthe	Québec	CA
3022	43 rue St. Laurent	H1J 1C3	Montréal	Québec	CA
3023	1900 Oak St.	V3F 2K1	Vancouver	BC	CA
3024	2319 Elm St.	V3F 2K1	Vancouver	BC	CA
3025	2960 Rue St. Laurent	H1J 1C3	Montréal	Québec	CA
3026	Vinbæltet 34	1734	Kobenhavn	\N	DK
3027	Smagsloget 45	8200	Århus	\N	DK
3028	Lyngbysild Fiskebakken 10	2800	Lyngby	\N	DK
3029	Keskuskatu 45	21240	Helsinki	\N	FI
3030	Torikatu 38	90110	Oulu	\N	FI
3031	Valtakatu 12	53120	Lappeenranta	\N	FI
3032	1 rue Alsace-Lorraine	31000	Toulouse	\N	FR
3033	203, Rue des Francs-Bourgeois	75004	Paris	\N	FR
3034	2, rue du Commerce	69004	Lyon	\N	FR
3035	12, rue des Bouchers	13008	Marseille	\N	FR
3036	24, place Kléber	67000	Strasbourg	\N	FR
3037	Bat. B 3, rue des Alpes	74000	Annecy	\N	FR
3038	67, avenue de l'Europe	78000	Versailles	\N	FR
3039	25, rue Lauriston	75016	Paris	\N	FR
3040	59 rue de l'Abbaye	51100	Reims	\N	FR
3041	67, rue des Cinquante Otages	44000	Nantes	\N	FR
3042	54, rue Royale	44000	Nantes	\N	FR
3043	22, rue H. Voiron	71300	Montceau	\N	FR
3044	265, boulevard Charonne	75012	Paris	\N	FR
3045	184, chaussée de Tournai	59000	Lille	\N	FR
3046	Magazinweg 7	60528	Frankfurt a.M.	\N	DE
3047	Maubelstr. 90	14776	Brandenburg	\N	DE
3048	Forsterstr. 57	68306	Mannheim	\N	DE
3049	Adenauerallee 900	70563	Stuttgart	\N	DE
3050	Bogenallee 51	60439	Frankfurt	\N	DE
3051	Heerstr. 22	04179	Leipzig	\N	DE
3052	Walserweg 21	52066	Aachen	\N	DE
3053	Mehrheimerstr. 369	50739	Köln	\N	DE
3054	Tiergartenstraße 5	10785	Berlin	\N	DE
3055	Berliner Platz 43	80805	München	\N	DE
3056	Obere Str. 57	12209	Berlin	\N	DE
3057	Taucherstraße 10	01307	Cunewalde	\N	DE
3058	Frahmredder 112a	27478	Cuxhaven	\N	DE
3059	Luisenstr. 48	44087	Münster	\N	DE
3060	8 Johnstown Road	\N	Cork	Co. Cork	IR
3061	Via dei Gelsomini, 153	84100	Salerno	\N	IT
3062	Strada Provinciale 124	42100	Reggio Emilia	\N	IT
3063	Via Ludovico il Moro 22	24100	Bergamo	\N	IT
3064	Viale Dante, 75	48100	Ravenna	\N	IT
3065	Via Monte Bianco 34	10100	Torino	\N	IT
3066	92 Setsuko Chuo-ku	545	Osaka	\N	JP
3067	9-8 Sekimai Musashino-shi	100	Tokyo	\N	JP
3068	Mataderos  2312	05023	México D.F.	\N	MX
3069	Avda. Azteca 123	05033	México D.F.	\N	MX
3070	Calle Dr. Jorge Cash 321	05033	México D.F.	\N	MX
3071	Avda. de la Constitución 2222	05021	México D.F.	\N	MX
3072	Sierras de Granada 9993	05022	México D.F.	\N	MX
3073	Verkoop Rijnweg 22	9999 ZZ	Zaandam	\N	NL
3074	Erling Skakkes gate 78	4110	Stavern	\N	NW
3075	Hatlevegen 5	1320	Sandvika	\N	NW
3076	ul. Filtrowa 68	01-012	Warszawa	\N	PL
3077	Estrada da saúde n. 58	1756	Lisboa	\N	PO
3078	Jardim das rosas n. 32	1675	Lisboa	\N	PO
3079	471 Serangoon Loop, Suite #402	0512	Singapore	\N	SG
3080	Rambla de Cataluña, 23	08022	Barcelona	\N	SP
3081	C/ Araquil, 67	28023	Madrid	\N	SP
3082	Gran Vía, 1	28001	Madrid	\N	SP
3083	Rambla de Cataluña, 23	8022	Barcelona	\N	SP
3084	Calle del Rosal 4	33007	Oviedo	Asturias	SP
3085	C/ Moralzarzal, 86	28034	Madrid	\N	SP
3086	C/ Romero, 33	41101	Sevilla	\N	SP
3087	Berguvsvägen  8	S-958 22	Luleå	\N	SW
3088	Kaloadagatan 13	S-345 67	Göteborg	\N	SW
3089	Åkergatan 24	S-844 67	Bräcke	\N	SW
3090	Brovallavägen 231	S-123 45	Stockholm	\N	SW
3091	Grenzacherweg 237	1203	Genève	\N	CH
3092	Starenweg 5	1204	Genève	\N	CH
3093	Hauptstr. 29	3012	Bern	\N	CH
3094	Hauptstr. 31	3012	Bern	\N	CH
3132	5ª Ave. Los Palos Grandes	1081	Caracas	DF	VZ
3133	Carrera 22 con Ave. Carlos Soublette #8-35	5022	San Cristóbal	Táchira	VZ
3134	Ave. 5 de Mayo Porlamar	4980	I. de Margarita	Nueva Esparta	VZ
3135	Carrera 52 con Ave. Bolívar #65-98 Llano Largo	3508	Barquisimeto	Lara	VZ
3109	1029 - 12th Ave. S.	98124	Seattle	WA	US
3110	4110 Old Redmond Rd.	98052	Redmond	WA	US
3111	187 Suffolk Ln.	83720	Boise	ID	US
3112	55 Grizzly Peak Rd.	59801	Butte	MT	US
3113	722 DaVinci Blvd.	98034	Kirkland	WA	US
3114	Order Processing Dept. 2100 Paul Revere Blvd.	02134	Boston	MA	US
3115	3400 - 8th Avenue Suite 210	97101	Bend	OR	US
3116	P.O. Box 78934	70117	New Orleans	LA	US
3117	305 - 14th Ave. S. Suite 3B	98128	Seattle	WA	US
3118	City Center Plaza 516 Main St.	97827	Elgin	OR	US
3119	2817 Milton Dr.	87110	Albuquerque	NM	US
3120	507 - 20th Ave. E.\\nApt. 2A	98122	Seattle	WA	US
3121	4726 - 11th Ave. N.E.	98105	Seattle	WA	US
3122	89 Chiaroscuro Rd.	97219	Portland	OR	US
3123	87 Polk St. Suite 5	94117	San Francisco	CA	US
3124	2743 Bering St.	99508	Anchorage	AK	US
3125	89 Jefferson Way Suite 2	97201	Portland	OR	US
3095	Fauntleroy Circus	EC2 5NT	London	\N	UK
3096	Coventry House\\nMiner Rd.	EC2 7JR	London	\N	UK
3097	49 Gilbert St.	EC1 4SD	London	\N	UK
3098	14 Garrett Hill	SW1 8JR	London	\N	UK
3099	Edgeham Hollow\\nWinchester Way	RG1 9SP	London	\N	UK
3100	90 Wadhurst Rd.	OX15 4NB	London	\N	UK
3101	35 King George	WX3 6FW	London	\N	UK
3102	7 Houndstooth Rd.	WG2 7LT	London	\N	UK
3103	29 King's Way	M14 GSD	Manchester	\N	UK
3104	Garden House Crowther Way	PO31 7PJ	Cowes	Isle of Wight	UK
3105	Brook Farm Stratford St. Mary	CO7 6JX	Colchester	Essex	UK
3106	Berkeley Gardens 12  Brewery	WX1 6LT	London	\N	UK
3107	120 Hanover Sq.	WA1 1DP	London	\N	UK
3108	South House 300 Queensbridge	SW7 1RZ	London	\N	UK
\.
...
--
-- Data for Name: categories; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.categories (category_id, category_name, description, picture) FROM stdin;
...
--
-- Data for Name: customer_customer_demo; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.customer_customer_demo (customer_id, customer_type_id) FROM stdin;
\.


--
-- Data for Name: customer_demographics; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.customer_demographics (customer_type_id, customer_desc) FROM stdin;
\.


--
-- Data for Name: customers; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.customers (customer_id, company_name, contact_name, contact_title, address, city, region, postal_code, country, phone, fax, location_id) FROM stdin;
BSBEV	B's Beverages	Victoria Ashworth	oe Representative	Fauntleroy Circus	London	\N	EC2 5NT	UK	(171) 555-1212	\N	3095
CACTU	Cactus Comidas para llevar	Patricio Simpson	oe Agent	Cerrito 333	Buenos Aires	\N	1010	Argentina	(1) 135-5555	(1) 135-4892	3003
CENTC	Centro comercial Moctezuma	Francisco Chang	Marketing Manager	Sierras de Granada 9993	México D.F.	\N	05022	Mexico	(5) 555-3392	(5) 555-7293	3072
CHOPS	Chop-suey Chinese	Yang Wang	Owner	Hauptstr. 29	Bern	\N	3012	Switzerland	0452-076545	\N	3093
CONSH	Consolidated Holdings	Elizabeth Brown	oe Representative	Berkeley Gardens 12  Brewery	London	\N	WX1 6LT	UK	(171) 555-2282	(171) 555-9199	3106
DRACD	Drachenblut Delikatessen	Sven Ottlieb	Order Administrator	Walserweg 21	Aachen	\N	52066	Germany	0241-039123	0241-059428	3052
DUMON	Du monde entier	Janine Labrune	Owner	67, rue des Cinquante Otages	Nantes	\N	44000	France	40.67.88.88	40.67.89.89	3041
EASTC	Eastern Connection	Ann Devon	oe Agent	35 King George	London	\N	WX3 6FW	UK	(171) 555-0297	(171) 555-3373	3101
ERNSH	Ernst Handel	Roland Mendel	oe Manager	Kirchgasse 6	Graz	\N	8010	Austria	7675-3425	7675-3426	3006
FISSA	FISSA Fabrica Inter. Salchichas S.A.	Diego Roel	Accounting Manager	C/ Moralzarzal, 86	Madrid	\N	28034	Spain	(91) 555 94 44	(91) 555 55 93	3085
FOLIG	Folies gourmandes	Martine Rancé	Assistant oe Agent	184, chaussée de Tournai	Lille	\N	59000	France	20.16.10.16	20.16.10.17	3045
FOLKO	Folk och fä HB	Maria Larsson	Owner	Åkergatan 24	Bräcke	\N	S-844 67	Sweden	0695-34 67 21	\N	3089
FRANK	Frankenversand	Peter Franken	Marketing Manager	Berliner Platz 43	München	\N	80805	Germany	089-0877310	089-0877451	3055
FRANR	France restauration	Carine Schmitt	Marketing Manager	54, rue Royale	Nantes	\N	44000	France	40.32.21.21	40.32.21.20	3042
FRANS	Franchi S.p.A.	Paolo Accorti	oe Representative	Via Monte Bianco 34	Torino	\N	10100	Italy	011-4988260	011-4988261	3065
FURIB	Furia Bacalhau e Frutos do Mar	Lino Rodriguez	oe Manager	Jardim das rosas n. 32	Lisboa	\N	1675	Portugal	(1) 354-2534	(1) 354-2535	3078
GALED	Galería del gastrónomo	Eduardo Saavedra	Marketing Manager	Rambla de Cataluña, 23	Barcelona	\N	08022	Spain	(93) 203 4560	(93) 203 4561	3080
GODOS	Godos Cocina Típica	José Pedro Freyre	oe Manager	C/ Romero, 33	Sevilla	\N	41101	Spain	(95) 555 82 82	\N	3086
QUEEN	Queen Cozinha	Lúcia Carvalho	Marketing Assistant	Alameda dos Canàrios, 891	Sao Paulo	SP	05487-020	Brazil	(11) 555-1189	\N	3010
RATTC	Rattlesnake Canyon Grocery	Paula Wilson	Assistant oe Representative	2817 Milton Dr.	Albuquerque	NM	87110	USA	(505) 555-5939	(505) 555-3620	3119
RICAR	Ricardo Adocicados	Janete Limeira	Assistant oe Agent	Av. Copacabana, 267	Rio de Janeiro	RJ	02389-890	Brazil	(21) 555-3412	\N	3015
SAVEA	Save-a-lot Markets	Jose Pavarotti	oe Representative	187 Suffolk Ln.	Boise	ID	83720	USA	(208) 555-8097	\N	3111
SPLIR	Split Rail Beer & Ale	Art Braunschweiger	oe Manager	P.O. Box 555	Lander	WY	82520	USA	(307) 555-4680	(307) 555-6525	3129
THEBI	The Big Cheese	Liz Nixon	Marketing Manager	89 Jefferson Way Suite 2	Portland	OR	97201	USA	(503) 555-3612	\N	3125
THECR	The Cracker Box	Liu Wong	Marketing Assistant	55 Grizzly Peak Rd.	Butte	MT	59801	USA	(406) 555-5834	(406) 555-8083	3112
TRADH	Tradição Hipermercados	Anabela Domingues	oe Representative	Av. Inês de Castro, 414	Sao Paulo	SP	05634-030	Brazil	(11) 555-2167	(11) 555-2168	3011
TRAIH	Trail's Head Gourmet Provisioners	Helvetius Nagy	oe Associate	722 DaVinci Blvd.	Kirkland	WA	98034	USA	(206) 555-8257	(206) 555-2174	3113
WELLI	Wellington Importadora	Paula Parente	oe Manager	Rua do Mercado, 12	Resende	SP	08737-363	Brazil	(14) 555-8122	\N	3012
WHITC	White Clover Markets	Karl Jablonski	Owner	305 - 14th Ave. S. Suite 3B	Seattle	WA	98128	USA	(206) 555-4112	(206) 555-4115	3117
QUICK	QUICK-Stop	Horst Kloss	Accounting Manager	Taucherstraße 10	Cunewalde	\N	01307	Germany	0372-035188	\N	3057
RANCH	Rancho grande	Sergio Gutiérrez	oe Representative	Av. del Libertador 900	Buenos Aires	\N	1010	Argentina	(1) 123-5555	(1) 123-5556	3001
REGGC	Reggiani Caseifici	Maurizio Moroni	oe Associate	Strada Provinciale 124	Reggio Emilia	\N	42100	Italy	0522-556721	0522-556722	3062
HUNGO	Hungry Owl All-Night Grocers	Patricia McKenna	oe Associate	8 Johnstown Road	Cork	Co. Cork	\N	Ireland	2967 542	2967 3333	\N
KOENE	Königlich Essen	Philip Cramer	oe Associate	Maubelstr. 90	Brandenburg	\N	14776	Germany	0555-09876	\N	3047
LACOR	La corne d'abondance	Daniel Tonini	oe Representative	67, avenue de l'Europe	Versailles	\N	78000	France	30.59.84.10	30.59.85.11	3038
LAMAI	La maison d'Asie	Annette Roulet	oe Manager	1 rue Alsace-Lorraine	Toulouse	\N	31000	France	61.77.61.10	61.77.61.11	3032
LEHMS	Lehmanns Marktstand	Renate Messner	oe Representative	Magazinweg 7	Frankfurt a.M.	\N	60528	Germany	069-0245984	069-0245874	3046
MAGAA	Magazzini Alimentari Riuniti	Giovanni Rovelli	Marketing Manager	Via Ludovico il Moro 22	Bergamo	\N	24100	Italy	035-640230	035-640231	3063
MAISD	Maison Dewey	Catherine Dewey	oe Agent	Rue Joseph-Bens 532	Bruxelles	\N	B-1180	Belgium	(02) 201 24 67	(02) 201 24 68	3008
BOTTM	Bottom-Dollar Markets	Elizabeth Lincoln	Accounting Manager	23 Tsawassen Blvd.	Tsawassen	BC	T2F 8M4	Canada	(604) 555-4729	(604) 555-3745	3020
COMMI	Comércio Mineiro	Pedro Afonso	oe Associate	Av. dos Lusíadas, 23	Sao Paulo	SP	05432-043	Brazil	(11) 555-7647	\N	3013
FAMIA	Familia Arquibaldo	Aria Cruz	Marketing Assistant	Rua Orós, 92	Sao Paulo	SP	05442-030	Brazil	(11) 555-9857	\N	3016
GOURL	Gourmet Lanchonetes	André Fonseca	oe Associate	Av. Brasil, 442	Campinas	SP	04876-786	Brazil	(11) 555-9482	\N	3019
GREAL	Great Lakes Food Market	Howard Snyder	Marketing Manager	2732 Baker Blvd.	Eugene	OR	97403	USA	(503) 555-7555	\N	3127
GROSR	GROSELLA-Restaurante	Manuel Pereira	Owner	5ª Ave. Los Palos Grandes	Caracas	DF	1081	Venezuela	(2) 283-2951	(2) 283-3397	3132
HANAR	Hanari Carnes	Mario Pontes	Accounting Manager	Rua do Paço, 67	Rio de Janeiro	RJ	05454-876	Brazil	(21) 555-0091	(21) 555-8765	3018
HILAA	HILARION-Abastos	Carlos Hernández	oe Representative	Carrera 22 con Ave. Carlos Soublette #8-35	San Cristóbal	Táchira	5022	Venezuela	(5) 555-1340	(5) 555-1948	3133
HUNGC	Hungry Coyote Import Store	Yoshi Latimer	oe Representative	City Center Plaza 516 Main St.	Elgin	OR	97827	USA	(503) 555-6874	(503) 555-2376	3118
ISLAT	Island Trading	Helen Bennett	Marketing Manager	Garden House Crowther Way	Cowes	Isle of Wight	PO31 7PJ	UK	(198) 555-8888	\N	3104
LAUGB	Laughing Bacchus Wine Cellars	Yoshi Tannamuri	Marketing Assistant	1900 Oak St.	Vancouver	BC	V3F 2K1	Canada	(604) 555-3392	(604) 555-7293	3023
LAZYK	Lazy K Kountry Store	John Steel	Marketing Manager	12 Orchestra Terrace	Walla Walla	WA	99362	USA	(509) 555-7969	(509) 555-6221	3126
LETSS	Let's Stop N Shop	Jaime Yorres	Owner	87 Polk St. Suite 5	San Francisco	CA	94117	USA	(415) 555-5938	\N	3123
LILAS	LILA-Supermercado	Carlos González	Accounting Manager	Carrera 52 con Ave. Bolívar #65-98 Llano Largo	Barquisimeto	Lara	3508	Venezuela	(9) 331-6954	(9) 331-7256	3135
LINOD	LINO-Delicateses	Felipe Izquierdo	Owner	Ave. 5 de Mayo Porlamar	I. de Margarita	Nueva Esparta	4980	Venezuela	(8) 34-56-12	(8) 34-93-93	3134
LONEP	Lonesome Pine Restaurant	Fran Wilson	oe Manager	89 Chiaroscuro Rd.	Portland	OR	97219	USA	(503) 555-9573	(503) 555-9646	3122
OLDWO	Old World Delicatessen	Rene Phillips	oe Representative	2743 Bering St.	Anchorage	AK	99508	USA	(907) 555-7584	(907) 555-2880	3124
MORGK	Morgenstern Gesundkost	Alexander Feuer	Marketing Assistant	Heerstr. 22	Leipzig	\N	04179	Germany	0342-023176	\N	3051
NORTS	North/South	Simon Crowther	oe Associate	South House 300 Queensbridge	London	\N	SW7 1RZ	UK	(171) 555-7733	(171) 555-2530	3108
OCEAN	Océano Atlántico Ltda.	Yvonne Moncada	oe Agent	Ing. Gustavo Moncada 8585 Piso 20-A	Buenos Aires	\N	1010	Argentina	(1) 135-5333	(1) 135-5535	3002
OTTIK	Ottilies Käseladen	Henriette Pfalzheim	Owner	Mehrheimerstr. 369	Köln	\N	50739	Germany	0221-0644327	0221-0765721	3053
PARIS	Paris spécialités	Marie Bertrand	Owner	265, boulevard Charonne	Paris	\N	75012	France	(1) 42.34.22.66	(1) 42.34.22.77	3044
PERIC	Pericles Comidas clásicas	Guillermo Fernández	oe Representative	Calle Dr. Jorge Cash 321	México D.F.	\N	05033	Mexico	(5) 552-3745	(5) 545-3745	3070
PICCO	Piccolo und mehr	Georg Pipps	oe Manager	Geislweg 14	Salzburg	\N	5020	Austria	6562-9722	6562-9723	3007
PRINI	Princesa Isabel Vinhos	Isabel de Castro	oe Representative	Estrada da saúde n. 58	Lisboa	\N	1756	Portugal	(1) 356-5634	\N	3077
ALFKI	Alfreds Futterkiste	Maria Anders	oe Representative	Obere Str. 57	Berlin	\N	12209	Germany	030-0074321	030-0076545	3056
ANATR	Ana Trujillo Emparedados y helados	Ana Trujillo	Owner	Avda. de la Constitución 2222	México D.F.	\N	05021	Mexico	(5) 555-4729	(5) 555-3745	3071
ANTON	Antonio Moreno Taquería	Antonio Moreno	Owner	Mataderos  2312	México D.F.	\N	05023	Mexico	(5) 555-3932	\N	3068
AROUT	Around the Horn	Thomas Hardy	oe Representative	120 Hanover Sq.	London	\N	WA1 1DP	UK	(171) 555-7788	(171) 555-6750	3107
BERGS	Berglunds snabbköp	Christina Berglund	Order Administrator	Berguvsvägen  8	Luleå	\N	S-958 22	Sweden	0921-12 34 65	0921-12 34 67	3087
BLAUS	Blauer See Delikatessen	Hanna Moos	oe Representative	Forsterstr. 57	Mannheim	\N	68306	Germany	0621-08460	0621-08924	3048
BLONP	Blondesddsl père et fils	Frédérique Citeaux	Marketing Manager	24, place Kléber	Strasbourg	\N	67000	France	88.60.15.31	88.60.15.32	3036
BOLID	Bólido Comidas preparadas	Martín Sommer	Owner	C/ Araquil, 67	Madrid	\N	28023	Spain	(91) 555 22 82	(91) 555 91 99	3081
BONAP	Bon app'	Laurence Lebihan	Owner	12, rue des Bouchers	Marseille	\N	13008	France	91.24.45.40	91.24.45.41	3035
MEREP	Mère Paillarde	Jean Fresnière	Marketing Assistant	43 rue St. Laurent	Montréal	Québec	H1J 1C3	Canada	(514) 555-8054	(514) 555-8055	3022
QUEDE	Que Delícia	Bernardo Batista	Accounting Manager	Rua da Panificadora, 12	Rio de Janeiro	RJ	02389-673	Brazil	(21) 555-4252	(21) 555-4545	3017
RICSU	Richter Supermarkt	Michael Holz	oe Manager	Grenzacherweg 237	Genève	\N	1203	Switzerland	0897-034214	\N	3091
ROMEY	Romero y tomillo	Alejandra Camino	Accounting Manager	Gran Vía, 1	Madrid	\N	28001	Spain	(91) 745 6200	(91) 745 6210	3082
SANTG	Santé Gourmet	Jonas Bergulfsen	Owner	Erling Skakkes gate 78	Stavern	\N	4110	Norway	07-98 92 35	07-98 92 47	3074
SEVES	Seven Seas Imports	Hari Kumar	oe Manager	90 Wadhurst Rd.	London	\N	OX15 4NB	UK	(171) 555-1717	(171) 555-5646	3100
SIMOB	Simons bistro	Jytte Petersen	Owner	Vinbæltet 34	Kobenhavn	\N	1734	Denmark	31 12 34 56	31 13 35 57	3026
SPECD	Spécialités du monde	Dominique Perrier	Marketing Manager	25, rue Lauriston	Paris	\N	75016	France	(1) 47.55.60.10	(1) 47.55.60.20	3039
SUPRD	Suprêmes délices	Pascale Cartrain	Accounting Manager	Boulevard Tirou, 255	Charleroi	\N	B-6000	Belgium	(071) 23 67 22 20	(071) 23 67 22 21	3009
TOMSP	Toms Spezialitäten	Karin Josephs	Marketing Manager	Luisenstr. 48	Münster	\N	44087	Germany	0251-031259	0251-035695	3059
TORTU	Tortuga Restaurante	Miguel Angel Paolino	Owner	Avda. Azteca 123	México D.F.	\N	05033	Mexico	(5) 555-2933	\N	3069
VAFFE	Vaffeljernet	Palle Ibsen	oe Manager	Smagsloget 45	Århus	\N	8200	Denmark	86 21 32 43	86 22 33 44	3027
VICTE	Victuailles en stock	Mary Saveley	oe Agent	2, rue du Commerce	Lyon	\N	69004	France	78.32.54.86	78.32.54.87	3034
VINET	Vins et alcools Chevalier	Paul Henriot	Accounting Manager	59 rue de l'Abbaye	Reims	\N	51100	France	26.47.15.10	26.47.15.11	3040
WANDK	Die Wandernde Kuh	Rita Müller	oe Representative	Adenauerallee 900	Stuttgart	\N	70563	Germany	0711-020361	0711-035428	3049
WARTH	Wartian Herkku	Pirkko Koskitalo	Accounting Manager	Torikatu 38	Oulu	\N	90110	Finland	981-443655	981-443655	3030
WILMK	Wilman Kala	Matti Karttunen	Owner/Marketing Assistant	Keskuskatu 45	Helsinki	\N	21240	Finland	90-224 8858	90-224 8858	3029
WOLZA	Wolski  Zajazd	Zbyszek Piestrzeniewicz	Owner	ul. Filtrowa 68	Warszawa	\N	01-012	Poland	(26) 642-7012	(26) 642-7012	3076
\.


--
-- Data for Name: employee_territories; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.employee_territories (employee_id, territory_id) FROM stdin;
1	06897
1	19713
2	01581
2	01730
...
--
-- Data for Name: employees; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.employees (employee_id, last_name, first_name, title, title_of_courtesy, birth_date, hire_date, address, city, region, postal_code, country, home_phone, extension, photo, notes, reports_to, photo_path) FROM stdin;
1	Davolio	Nancy	oe Representative	Ms.	1948-12-08	1992-05-01	507 - 20th Ave. E.\\nApt. 2A	Seattle	WA	98122	USA	(206) 555-9857	5467	\\x	Education includes a BA in psychology from Colorado State University in 1970.  She also completed The Art of the Cold Call.  Nancy is a member of Toastmasters International.	2	http://accweb/emmployees/davolio.bmp
...
3	Leverling	Janet	oe Representative	Ms.	1963-08-30	1992-04-01	722 Moss Bay Blvd.	Kirkland	WA	98033	USA	(206) 555-3412	3355	\\x	Janet has a BS degree in chemistry from Boston College (1984).  She has also completed a certificate program in food retailing management.  Janet was hired as a oe associate in 1991 and promoted to oe representative in February 1992.	2	http://accweb/emmployees/leverling.bmp
4	Peacock	Margaret	oe Representative	Mrs.	1937-09-19	1993-05-03	4110 Old Redmond Rd.	Redmond	WA	98052	USA	(206) 555-8122	5176	\\x	Margaret holds a BA in English literature from Concordia College (1958) and an MA from the American Institute of Culinary Arts (1966).  She was assigned to the London office temporarily from July through November 1992.	2	http://accweb/emmployees/peacock.bmp
5	Buchanan	Steven	oe Manager	Mr.	1955-03-04	1993-10-17	14 Garrett Hill	London	\N	SW1 8JR	UK	(71) 555-4848	3453	\\x	Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree in 1976.  Upon joining the company as a oe representative in 1992, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London.  He was promoted to oe manager in March 1993.  Mr. Buchanan has completed the courses Successful Telemarketing and International oe Management.  He is fluent in French.	2	http://accweb/emmployees/buchanan.bmp
6	Suyama	Michael	oe Representative	Mr.	1963-07-02	1993-10-17	Coventry House\\nMiner Rd.	London	\N	EC2 7JR	UK	(71) 555-7773	428	\\x	Michael is a graduate of Sussex University (MA, economics, 1983) and the University of California at Los Angeles (MBA, marketing, 1986).  He has also taken the courses Multi-Cultural Selling and Time Management for the oe Professional.  He is fluent in Japanese and can read and write French, Portuguese, and Spanish.	5	http://accweb/emmployees/davolio.bmp
7	King	Robert	oe Representative	Mr.	1960-05-29	1994-01-02	Edgeham Hollow\\nWinchester Way	London	\N	RG1 9SP	UK	(71) 555-5598	465	\\x	Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan in 1992, the year he joined the company.  After completing a course entitled Selling in Europe, he was transferred to the London office in March 1993.	5	http://accweb/emmployees/davolio.bmp
...
9	Dodsworth	Anne	oe Representative	Ms.	1966-01-27	1994-11-15	7 Houndstooth Rd.	London	\N	WG2 7LT	UK	(71) 555-4444	452	\\x	Anne has a BA degree in English from St. Lawrence College.  She is fluent in French and German.	5	http://accweb/emmployees/davolio.bmp
\.


--
-- Data for Name: location_x; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.location_x (location_id, street_address, postal_code, city, state_province, country_name, country_id) FROM stdin;
3126	12 Orchestra Terrace	99362	Walla Walla	WA	USA	US
3127	2732 Baker Blvd.	97403	Eugene	OR	USA	US
3128	707 Oxford Rd.	48104	Ann Arbor	MI	USA	US
3129	P.O. Box 555	82520	Lander	WY	USA	US
3130	908 W. Capital Way	98401	Tacoma	WA	USA	US
3131	722 Moss Bay Blvd.	98033	Kirkland	WA	USA	US
3001	Av. del Libertador 900	1010	Buenos Aires	\N	Argentina	AR
3002	Ing. Gustavo Moncada 8585 Piso 20-A	1010	Buenos Aires	\N	Argentina	AR
3003	Cerrito 333	1010	Buenos Aires	\N	Argentina	AR
3004	170 Prince Edward Parade Hunter's Hill	2042	Sydney	NSW	Australia	AU
3005	74 Rose St. Moonie Ponds	3058	Melbourne	Victoria	Australia	AU
3006	Kirchgasse 6	8010	Graz	\N	Austria	AT
3007	Geislweg 14	5020	Salzburg	\N	Austria	AT
3008	Rue Joseph-Bens 532	B-1180	Bruxelles	\N	Belgium	BE
3009	Boulevard Tirou, 255	B-6000	Charleroi	\N	Belgium	BE
3010	Alameda dos Canàrios, 891	05487-020	Sao Paulo	SP	Brazil	BR
3011	Av. Inês de Castro, 414	05634-030	Sao Paulo	SP	Brazil	BR
3012	Rua do Mercado, 12	08737-363	Resende	SP	Brazil	BR
3013	Av. dos Lusíadas, 23	05432-043	Sao Paulo	SP	Brazil	BR
3014	Av. das Americanas 12.890	5442	Sao Paulo	\N	Brazil	BR
3015	Av. Copacabana, 267	02389-890	Rio de Janeiro	RJ	Brazil	BR
3016	Rua Orós, 92	05442-030	Sao Paulo	SP	Brazil	BR
3017	Rua da Panificadora, 12	02389-673	Rio de Janeiro	RJ	Brazil	BR
3018	Rua do Paço, 67	05454-876	Rio de Janeiro	RJ	Brazil	BR
3019	Av. Brasil, 442	04876-786	Campinas	SP	Brazil	BR
3020	23 Tsawassen Blvd.	T2F 8M4	Tsawassen	BC	Canada	CA
3021	148 rue Chasseur	J2S 7S8	Ste-Hyacinthe	Québec	Canada	CA
3022	43 rue St. Laurent	H1J 1C3	Montréal	Québec	Canada	CA
3023	1900 Oak St.	V3F 2K1	Vancouver	BC	Canada	CA
3024	2319 Elm St.	V3F 2K1	Vancouver	BC	Canada	CA
3025	2960 Rue St. Laurent	H1J 1C3	Montréal	Québec	Canada	CA
3026	Vinbæltet 34	1734	Kobenhavn	\N	Denmark	DK
3027	Smagsloget 45	8200	Århus	\N	Denmark	DK
3028	Lyngbysild Fiskebakken 10	2800	Lyngby	\N	Denmark	DK
3029	Keskuskatu 45	21240	Helsinki	\N	Finland	FI
3030	Torikatu 38	90110	Oulu	\N	Finland	FI
3031	Valtakatu 12	53120	Lappeenranta	\N	Finland	FI
3032	1 rue Alsace-Lorraine	31000	Toulouse	\N	France	FR
3033	203, Rue des Francs-Bourgeois	75004	Paris	\N	France	FR
3034	2, rue du Commerce	69004	Lyon	\N	France	FR
3035	12, rue des Bouchers	13008	Marseille	\N	France	FR
3036	24, place Kléber	67000	Strasbourg	\N	France	FR
3037	Bat. B 3, rue des Alpes	74000	Annecy	\N	France	FR
3038	67, avenue de l'Europe	78000	Versailles	\N	France	FR
3039	25, rue Lauriston	75016	Paris	\N	France	FR
3040	59 rue de l'Abbaye	51100	Reims	\N	France	FR
3041	67, rue des Cinquante Otages	44000	Nantes	\N	France	FR
3042	54, rue Royale	44000	Nantes	\N	France	FR
3043	22, rue H. Voiron	71300	Montceau	\N	France	FR
3044	265, boulevard Charonne	75012	Paris	\N	France	FR
3045	184, chaussée de Tournai	59000	Lille	\N	France	FR
3046	Magazinweg 7	60528	Frankfurt a.M.	\N	Germany	DE
3047	Maubelstr. 90	14776	Brandenburg	\N	Germany	DE
3048	Forsterstr. 57	68306	Mannheim	\N	Germany	DE
3049	Adenauerallee 900	70563	Stuttgart	\N	Germany	DE
3050	Bogenallee 51	60439	Frankfurt	\N	Germany	DE
3051	Heerstr. 22	04179	Leipzig	\N	Germany	DE
3052	Walserweg 21	52066	Aachen	\N	Germany	DE
3053	Mehrheimerstr. 369	50739	Köln	\N	Germany	DE
3054	Tiergartenstraße 5	10785	Berlin	\N	Germany	DE
3055	Berliner Platz 43	80805	München	\N	Germany	DE
3056	Obere Str. 57	12209	Berlin	\N	Germany	DE
3057	Taucherstraße 10	01307	Cunewalde	\N	Germany	DE
3058	Frahmredder 112a	27478	Cuxhaven	\N	Germany	DE
3059	Luisenstr. 48	44087	Münster	\N	Germany	DE
3060	8 Johnstown Road	\N	Cork	Co. Cork	Ireland	IR
3061	Via dei Gelsomini, 153	84100	Salerno	\N	Italy	IT
3062	Strada Provinciale 124	42100	Reggio Emilia	\N	Italy	IT
3063	Via Ludovico il Moro 22	24100	Bergamo	\N	Italy	IT
3064	Viale Dante, 75	48100	Ravenna	\N	Italy	IT
3065	Via Monte Bianco 34	10100	Torino	\N	Italy	IT
3066	92 Setsuko Chuo-ku	545	Osaka	\N	Japan	JP
3067	9-8 Sekimai Musashino-shi	100	Tokyo	\N	Japan	JP
3068	Mataderos  2312	05023	México D.F.	\N	Mexico	MX
3069	Avda. Azteca 123	05033	México D.F.	\N	Mexico	MX
3070	Calle Dr. Jorge Cash 321	05033	México D.F.	\N	Mexico	MX
3071	Avda. de la Constitución 2222	05021	México D.F.	\N	Mexico	MX
3072	Sierras de Granada 9993	05022	México D.F.	\N	Mexico	MX
3073	Verkoop Rijnweg 22	9999 ZZ	Zaandam	\N	Netherlands	NL
3074	Erling Skakkes gate 78	4110	Stavern	\N	Norway	NW
3075	Hatlevegen 5	1320	Sandvika	\N	Norway	NW
3076	ul. Filtrowa 68	01-012	Warszawa	\N	Poland	PL
3077	Estrada da saúde n. 58	1756	Lisboa	\N	Portugal	PO
3078	Jardim das rosas n. 32	1675	Lisboa	\N	Portugal	PO
3079	471 Serangoon Loop, Suite #402	0512	Singapore	\N	Singapore	SG
3080	Rambla de Cataluña, 23	08022	Barcelona	\N	Spain	SP
3081	C/ Araquil, 67	28023	Madrid	\N	Spain	SP
3082	Gran Vía, 1	28001	Madrid	\N	Spain	SP
3083	Rambla de Cataluña, 23	8022	Barcelona	\N	Spain	SP
3084	Calle del Rosal 4	33007	Oviedo	Asturias	Spain	SP
3085	C/ Moralzarzal, 86	28034	Madrid	\N	Spain	SP
3086	C/ Romero, 33	41101	Sevilla	\N	Spain	SP
3087	Berguvsvägen  8	S-958 22	Luleå	\N	Sweden	SW
3088	Kaloadagatan 13	S-345 67	Göteborg	\N	Sweden	SW
3089	Åkergatan 24	S-844 67	Bräcke	\N	Sweden	SW
3090	Brovallavägen 231	S-123 45	Stockholm	\N	Sweden	SW
3091	Grenzacherweg 237	1203	Genève	\N	Switzerland	CH
3092	Starenweg 5	1204	Genève	\N	Switzerland	CH
3093	Hauptstr. 29	3012	Bern	\N	Switzerland	CH
3094	Hauptstr. 31	3012	Bern	\N	Switzerland	CH
3132	5ª Ave. Los Palos Grandes	1081	Caracas	DF	Venezuela	VZ
3133	Carrera 22 con Ave. Carlos Soublette #8-35	5022	San Cristóbal	Táchira	Venezuela	VZ
3134	Ave. 5 de Mayo Porlamar	4980	I. de Margarita	Nueva Esparta	Venezuela	VZ
3135	Carrera 52 con Ave. Bolívar #65-98 Llano Largo	3508	Barquisimeto	Lara	Venezuela	VZ
3109	1029 - 12th Ave. S.	98124	Seattle	WA	USA	US
3110	4110 Old Redmond Rd.	98052	Redmond	WA	USA	US
3111	187 Suffolk Ln.	83720	Boise	ID	USA	US
3112	55 Grizzly Peak Rd.	59801	Butte	MT	USA	US
3113	722 DaVinci Blvd.	98034	Kirkland	WA	USA	US
3114	Order Processing Dept. 2100 Paul Revere Blvd.	02134	Boston	MA	USA	US
3115	3400 - 8th Avenue Suite 210	97101	Bend	OR	USA	US
3116	P.O. Box 78934	70117	New Orleans	LA	USA	US
3117	305 - 14th Ave. S. Suite 3B	98128	Seattle	WA	USA	US
3118	City Center Plaza 516 Main St.	97827	Elgin	OR	USA	US
3119	2817 Milton Dr.	87110	Albuquerque	NM	USA	US
3120	507 - 20th Ave. E.\\nApt. 2A	98122	Seattle	WA	USA	US
3121	4726 - 11th Ave. N.E.	98105	Seattle	WA	USA	US
3122	89 Chiaroscuro Rd.	97219	Portland	OR	USA	US
3123	87 Polk St. Suite 5	94117	San Francisco	CA	USA	US
3124	2743 Bering St.	99508	Anchorage	AK	USA	US
3125	89 Jefferson Way Suite 2	97201	Portland	OR	USA	US
3095	Fauntleroy Circus	EC2 5NT	London	\N	UK	UK
3096	Coventry House\\nMiner Rd.	EC2 7JR	London	\N	UK	UK
3097	49 Gilbert St.	EC1 4SD	London	\N	UK	UK
3098	14 Garrett Hill	SW1 8JR	London	\N	UK	UK
3099	Edgeham Hollow\\nWinchester Way	RG1 9SP	London	\N	UK	UK
3100	90 Wadhurst Rd.	OX15 4NB	London	\N	UK	UK
3101	35 King George	WX3 6FW	London	\N	UK	UK
3102	7 Houndstooth Rd.	WG2 7LT	London	\N	UK	UK
3103	29 King's Way	M14 GSD	Manchester	\N	UK	UK
3104	Garden House Crowther Way	PO31 7PJ	Cowes	Isle of Wight	UK	UK
3105	Brook Farm Stratford St. Mary	CO7 6JX	Colchester	Essex	UK	UK
3106	Berkeley Gardens 12  Brewery	WX1 6LT	London	\N	UK	UK
3107	120 Hanover Sq.	WA1 1DP	London	\N	UK	UK
3108	South House 300 Queensbridge	SW7 1RZ	London	\N	UK	UK
\.


--
-- Data for Name: order_details; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.order_details (order_id, product_id, unit_price, quantity, discount) FROM stdin;
10248	11	14	12	0
10248	42	9.8	10	0
10248	72	34.8	5	0
10249	14	18.6	9	0
...
--
-- Data for Name: orders; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.orders (order_id, customer_id, employee_id, order_date, required_date, shipped_date, ship_via, freight, ship_name, ship_address, ship_city, ship_region, ship_postal_code, ship_country) FROM stdin;
...
--
-- Data for Name: products; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.products (product_id, product_name, supplier_id, category_id, quantity_per_unit, unit_price, units_in_stock, units_on_order, reorder_level, discontinued) FROM stdin;
...
--
-- Data for Name: region; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.region (region_id, region_description) FROM stdin;
1	Eastern
2	Western
3	Northern
4	Southern
...
COPY oe.shippers (shipper_id, company_name, phone) FROM stdin;
...
COPY oe.suppliers (supplier_id, company_name, contact_name, contact_title, address, city, region, postal_code, country, phone, fax, homepage) FROM stdin;
...
3	Grandma Kelly's Homestead	Regina Murphy	oe Representative	707 Oxford Rd.	Ann Arbor	MI	48104	USA	(313) 555-5735	(313) 555-3349	\N
...
8	Specialty Biscuits, Ltd.	Peter Wilson	oe Representative	29 King's Way	Manchester	\N	M14 GSD	UK	(161) 555-4448	\N	\N
9	PB Knäckebröd AB	Lars Peterson	oe Agent	Kaloadagatan 13	Göteborg	\N	S-345 67	Sweden	031-987 65 43	031-987 65 91	\N
...
11	Heli Süßwaren GmbH & Co. KG	Petra Winkler	oe Manager	Tiergartenstraße 5	Berlin	\N	10785	Germany	(010) 9984510	\N	\N
...
14	Formaggi Fortini s.r.l.	Elio Rossi	oe Representative	Viale Dante, 75	Ravenna	\N	48100	Italy	(0544) 60323	(0544) 60603	#FORMAGGI.HTM#
...
17	Svensk Sjöföda AB	Michael Björn	oe Representative	Brovallavägen 231	Stockholm	\N	S-123 45	Sweden	08-123 45 67	\N	\N
18	Aux joyeux ecclésiastiques	Guylène Nodier	oe Manager	203, Rue des Francs-Bourgeois	Paris	\N	75004	France	(1) 03.83.00.68	(1) 03.83.00.62	\N
...
21	Lyngbysild	Niels Petersen	oe Manager	Lyngbysild Fiskebakken 10	Lyngby	\N	2800	Denmark	43844108	43844115	\N
...
24	G'day, Mate	Wendy Mackenzie	oe Representative	170 Prince Edward Parade Hunter's Hill	Sydney	NSW	2042	Australia	(02) 555-5914	(02) 555-4873	G'day Mate (on the World Wide Web)#http://www.microsoft.com/accessdev/sampleapps/gdaymate.htm#
...
27	Escargots Nouveaux	Marie Delamare	oe Manager	22, rue H. Voiron	Montceau	\N	71300	France	85.57.00.07	\N	\N
28	Gai pâturage	Eliane Noz	oe Representative	Bat. B 3, rue des Alpes	Annecy	\N	74000	France	38.76.98.06	38.76.98.58	\N
...
--
-- Data for Name: territories; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.territories (territory_id, territory_description, region_id) FROM stdin;
01581	Westboro	1
01730	Bedford	1
01833	Georgetow	1
02116	Boston	1
...
--
-- Data for Name: us_states; Type: TABLE DATA; Schema: oe; Owner: postgres
--

COPY oe.us_states (state_id, state_name, state_abbr, state_region) FROM stdin;
1	Alabama	AL	south
2	Alaska	AK	north
3	Arizona	AZ	west
4	Arkansas	AR	south
...
--
-- Name: categories pk_categories; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: customer_customer_demo pk_customer_customer_demo; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: customer_demographics pk_customer_demographics; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: customers pk_customers; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: employee_territories pk_employee_territories; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: employees pk_employees; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: order_details pk_order_details; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: orders pk_orders; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: products pk_products; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: region pk_region; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: shippers pk_shippers; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: suppliers pk_suppliers; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: territories pk_territories; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: us_states pk_usstates; Type: CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: dependents dependents_employee_id_fkey; Type: FK CONSTRAINT; Schema: hr; Owner: postgres
--
...
--
-- Name: customers customer_location_fk; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: customer_customer_demo fk_customer_customer_demo_customer_demographics; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: customer_customer_demo fk_customer_customer_demo_customers; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: employee_territories fk_employee_territories_employees; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: employee_territories fk_employee_territories_territories; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: employees fk_employees_employees; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: order_details fk_order_details_orders; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: order_details fk_order_details_products; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: orders fk_orders_customers; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: orders fk_orders_employees; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: orders fk_orders_shippers; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: products fk_products_categories; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: products fk_products_suppliers; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
...
--
-- Name: territories fk_territories_region; Type: FK CONSTRAINT; Schema: oe; Owner: postgres
--
